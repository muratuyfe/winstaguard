...
let oziemb = new Discord.MessageEmbed()
    ...
    .setFooter("", executor.user.displayAvatarURL({dynamic: true}))
    .setTimestamp()
//Id girilcek yerler
let cezarolu = osettings.banhammer || "772388235946360842"; // Proje hazır proje değilse id girilcek
let cezalog = message.guild.channels.cache.get(osettings.cezalog) ||  message.guild.channels.cache.get("772151873170964520") //buraya da aynı şekil 
...
exports.conf = {
    enabled: true,
    guildOnly: true,
    aliases: ["ozzy","yak","yargıla","yasakla"],
    permLevel: 0
  } // Ban By Ozzy
  exports.help = {
    name: 'ban',
    description: 'ban kodu lo',
    usage: '.ban id/@etiket sebep'
  }